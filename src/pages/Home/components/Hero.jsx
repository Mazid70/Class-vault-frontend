...
const Hero = () => {
  return (
    <main className="relative">
      ...
      <section className="container mx-auto 2xl:mt-28 xl:mt-20 flex justify-center flex-col items-center">
        {/* for text  */}
        <div className="flex gap-3 alegreya items-center">
          <h1 className="font-bold text-9xl xl:text-8xl bg-gradient-to-r from-white  to-gray-600  text-transparent bg-clip-text">
            {' '}
            Students
          </h1>
          <h1 className="font-bold text-9xl xl:text-8xl bg-gradient-to-r from-gray-600  to-white  text-transparent bg-clip-text">
            {' '}
            CSE 54(1)
          </h1>
        </div>
        <h2 className="font-bold text-9xl xl:text-8xl mt-4 alegreya ">
          {' '}
          Of{' '}
        ...
        {/* card */}
        <div className="flex justify-evenly 2xl:justify-center w-full ">
          ...
          <div className="2xl:flex-1 ">
            <img
              src={hero}
              alt=""
              className="xl:h-[600px]  2xl:h-[680px] -mt-40 w-full  2xl:-ml-[200px]"
            />
          </div>
          <div>
            <ul className="text-white/70 text-lg space-y-2 mb-5">
